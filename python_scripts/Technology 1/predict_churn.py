...
def decision_tree_churn_survey(cid, db_connection_str) -> int:
    ...
    ux_train, ux_test, uy_train, uy_test = train_test_split(X_U, y_U, test_size=0.5, random_state=42)
...
if __name__ == '__main__':
    ...
    parser.add_argument('mysql_url', type=int, nargs='?', help='URL of mysql')
    args = parser.parse_args()
    print(decision_tree_churn_survey(args.cusomter_ID, args.mysql_url))
